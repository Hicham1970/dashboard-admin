...
export default function DS() {
  ...
  }, [aftCorrected, aftCorrectedFinal, aftDistance, aftPort, aftPortFinal, aftStbd, aftStbdFinal, ballast, ballastFinal, cargo, constant, density, diesel, dieselFinal, displacement, displacementDstyCorrected, displacementFinal, displacementInf, displacementInfFinal, displacementSup, displacementTrimCorrected, displacementTrimCorrectedFinal, draftInf, draftInfFinal, draftSup, draftSupFinal, firstTrimCorrection, foreCorrected, foreCorrectedFinal, foreDistance, forePort, forePortFinal, foreStbd, foreStbdFinal, freshWater, freshWaterFinal, fuel, fuelFinal, keelCorrection, lbm, lbmFinal, lbp, lcf, lcfFinal, lcfInfFinal, lcfSupFinal, lightship, lubOil, lubOilFinal, meanAft, meanAftFinal, meanFore, meanForeAft, meanForeAftFinal, meanForeFinal, meanMid, meanMidFinal, meanOfMean, meanOfMeanFinal, midCorrected, midCorrectedFinal, midDistance, midPort, midPortFinal, midStbd, midStbdFinal, mtcMinus50, mtcMinus50Final, mtcPlus50, mtcPlus50Final, netLight, netLoad, others, othersFinal, quarter, quarterMean, quarterMeanFinal, quarterMinus50, quarterMinus50Final, quarterPlus50, quarterPlus50Final, secondTrimCorrection, total, totalFinal, tpc, tpcFinal, tpcInfFinal, tpcSupFinal, trim, trimCorrected, trimCorrectedFinal, trimFinal]);
