...
export default function ValeursInitial() {
  ...
  const [hydrostaticTable, setHydrostaticTable] = useState([]);
  ...
  useEffect(() => {
    ...
    // getHydrostaticValuesSup(draftSup);
    // getHydrostaticValuesInf(draftInf);
    setTpc(tpc);
    setLcf(lcf);
